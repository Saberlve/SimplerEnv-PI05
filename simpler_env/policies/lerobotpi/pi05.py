...
def auto_model_fn(path):
    ...
    # Difference from pi0: Import PI05Policy instead of PI0Policy
    from modeling_pi05 import PI05Policy
    return PI05Policy

class LerobotPi05Inference:
    def __init__(
        self,
        # Difference from pi0: Default path points to pi05
        ...
        PI05Policy = auto_model_fn(saved_model_path)
